...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/teamsPlayers/dropoviPlayers.css" />
...
<body onload="showCheckboxes();showCheckboxes2();showCheckboxes3() ;showCheckboxes4();  showRanks(); showRanks2();">
    ...
    <div class='mainContainer'>
        ...
        <div class="glavniContainer">
            ...
            <div class="mainTekst">Find Players</div>
            <!--FILTEERI-->
                        ...
                        <div>
                            ...
                            <div style="position:relative" id="rankDrop3">
                                <div class="drop-down3">
                                    <select name="options3" id="rankFromFilter">
                        ...
                        <div style="position:relative">
                            ...
                            <div style="position:relative" id="rankDrop2">
                                <div class="drop-down2">
                                    <select name="options2" id="rankToFilter">
                                        ...
                                        <option class="radiant2" selected value="8" style="background-image:url('images/teamsPlayers/Radiant.png');">
                                            Radiant
                                        </option>
                                    </select>
                                </div>
                ...
                <div class="formular">
                    ...
                    <?php if (isset($_SESSION['userid'])) { ?>
                        <div id="formularContainer">
                            <div class="formularContainer fcPlayers" style="border-bottom-left-radius:15px;border-bottom-right-radius:15px;">
                                <div>
                                    <div class="Formular-tekst">Type of player :</div>
                                ...
                                <div style="" style="">
                                    <div class="Formular-tekst">Your rank :</div>
                                    <div style="position:relative" id="rankDrop1">
                                        <div class="drop-down">
                                            <select name="options" id="yourRank">
                                                <option class="iron" value="1" style="background-image:url('images/teamsPlayers/Iron.png');">
                                                    Iron
                                                </option>
                                                <option class="bronze" value="2" style="background-image:url('images/teamsPlayers/Bronze2.png');">
...
<script>
    ...
    function updateLfg() {
        $("#lfg").load("includes/update-lfg.inc.php", {
            ...
            filterRankFrom: document.getElementById("rankFromFilter").value,
            filterRankTo: document.getElementById("rankToFilter").value,
            ...
            if (document.getElementById('message').value == "" || document.getElementById('riotUsername').value == "") {
                ...
                if (loginCondition == true) {
                    $("#formularContainer").load("includes/submitlfg.inc.php", {
                        ...
                        yourRank: document.getElementById("yourRank").value,
